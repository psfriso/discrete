!
! $Date: 2012-11-02 11:17:45 $
! $Id: geometryDP.f,v 1.2 2012-11-02 11:17:45 gelpi Exp $
! $Revision: 1.2 $
!
 MODULE geometryDP
...
! Error intern de compilador gfortran a cygwin
!function signCosangDP (v1,v2)
!real :: signCosangDP
!type (pointDP), intent (IN) :: v1,v2
!signcosangDP=sign (1.,real(dotDP(v1,v2)))
!end function signCosangDP
